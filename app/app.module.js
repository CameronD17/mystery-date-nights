...
var date_night_date_order_pipe_1 = require('./date-night-list/date-night-date-order.pipe');
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                date_night_about_component_1.DateNightAboutComponent,
                date_night_list_component_1.DateNightListComponent,
                date_night_filter_pipe_1.DateNightFilterPipe,
                date_night_date_order_pipe_1.DateNightOrderPipe,
                date_night_date_filter_pipe_1.DateNightIconFilterPipe,
            ...
            providers: [
                date_night_service_1.DateNightService,
                {
